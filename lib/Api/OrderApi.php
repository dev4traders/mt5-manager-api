...
class OrderApi
{
     ...
     * @return \Swagger\Client\Model\ArrayOfPositions
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ArrayOfPositions, HTTP status code, HTTP response headers (array of strings)
     */
    public function positionsUserLoginGetWithHttpInfo($user_login)
    {
        $returnType = '\Swagger\Client\Model\ArrayOfPositions';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ArrayOfPositions',
